...
def daticoonfig():
    ...
    config_data = {
        "colormap" : g_box_config.magnetic_map_color,
        "inter" : g_box_config.magnetic_map_interpolation,
        "odr" : g_box_config.output_data_rate,
        "ble" : g_box_config.bluetooth_scan_time,
        "server" : g_box_config.server_ip,
        "port" : g_box_config.server_port,
        "cali" : 20
    }

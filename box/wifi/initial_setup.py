...
print()
print()
install_ans = input("Sei pronto per eseguire il commit delle modifiche alle configurazioni di rete del sistema? [y/N]: ")
...
if(install_ans.lower() == 'y'):
	...
	print("---------------------------------------------------")
	print()
	print("WiFi installation cancelled. Nothing changed...")
	print()
	print("---------------------------------------------------")
	print("===================================================")
	print()
